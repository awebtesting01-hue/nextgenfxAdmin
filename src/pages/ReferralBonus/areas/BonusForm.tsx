// components/ReferralBonus/BonusForm.tsx
import { Plus, Save, X, Layers, DollarSign, Percent } from 'lucide-react';
...
interface BonusFormProps {
    ...
    onCommissionTypeChange: (type: 'flat' | 'percent') => void;
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-gray-800">
                            {editingId ? 'Edit Bonus Slab' : 'Add New Bonus Slab'}
                        </h2>
                        <p className="text-gray-600 text-sm">Create or edit referral bonus slabs</p>
                    </div>
                </div>
            </div>
